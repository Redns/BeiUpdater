...
namespace BeiUpdater.Common
{
    public class Email
    {
        ...
        public Email(MailboxAddress from, IEnumerable<MailboxAddress> to, string title, string body, string code, bool isBodyHtml)
        {
            From = from;
            To = to;
            Title = title;
        ...
        public Email(MailboxAddress from, MailboxAddress to, string title, string body, string code, bool isBodyHtml)
        {
            From = from;
